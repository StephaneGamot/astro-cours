...
export const autre: Item[] = [
  ...
  },
  {
    ...
    href: "/revolution-solaire",
    icon: glyph("℞"),
  },
  {
    name: "Nœuds lunaires",
    description: "Axe karmique",
    href: "/noeuds-lunaires",
    icon: glyph("☊"),
  },
  {
    name: "Astéroïdes",
