...
const IconFacebook: SvgIcon = (props) => (
...
/* ────────────────────────────────────────────────────────────────
   Social links — add new networks here as they come
   ──────────────────────────────────────────────────────────────── */

type SocialLink = { name: string; href: string; icon: SvgIcon; hoverColor: string };

const SOCIALS: SocialLink[] = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61577719253973",
    icon: IconFacebook,
    hoverColor: "hover:text-[#1877F2] hover:border-[#1877F2]/30 hover:bg-[#1877F2]/10",
  },
];
