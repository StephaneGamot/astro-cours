...
const PLANET_ARTICLES: Record<string, string[]> = {
  ...
  lune: ["lune-en-signes-emotions-besoins", "lunarien", "calendrier-pleine-lune-nouvelle-lune-2026-2027", "pleine-lune-nouvelle-lune-cycles-astrologie"],
...
const HOUSE_ARTICLES: Record<string, string[]> = {
  ...
  "maison-4": ["lune-en-signes-emotions-besoins", "vendre-une-maison-demenager-astrologie-methodes", "lunarien"],
