...
/* ================================================================== */
/*  Styles par catégorie (pour la légende uniquement)                 */
/* ================================================================== */
...
/* ================================================================== */
/*  Page (Server Component — conserve les metadata + JSON-LD)         */
/* ================================================================== */
export default function DictionnairePage() {
  ...
  return (
    <main className="relative mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16 lg:py-20">
      {/* ── Schema.org DefinedTermSet (SEO : toutes les entrées) ── */}
      <script
      ...
      {/* ── Entrées par lettre (lazy-rendered) ── */}
