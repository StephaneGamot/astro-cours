    ...
    <>
      ...
      <main className="relative mx-auto max-w-6xl px-6 pb-24 text-text selection:bg-violet-500/30">
        ...
        <header className="relative mb-24 pt-16 text-center md:text-left">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="relative w-full max-w-md aspect-[4/5] rounded-[3rem] overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(167,139,250,0.15)]">
              <Image
                src="/images/articles/cuspides-maisons/a.webp"
        ...
        <footer className="mt-32 border-t border-white/10 pt-16 flex flex-col items-center gap-8">
          <Link
            href="/articles"
            className="group flex items-center gap-3 rounded-full border border-violet-500/30 bg-violet-500/10 px-8 py-4 text-[15px] font-bold uppercase tracking-widest text-violet-300 transition-all hover:bg-violet-500/20 hover:shadow-[0_0_20px_rgba(167,139,250,0.2)]"
          >
            <ArrowLeft size={20} className="transition-transform group-hover:-translate-x-2" />
            Explorer d'autres articles
          </Link>
          <p className="text-xs text-slate-600 uppercase tracking-[0.3em] font-bold mt-4">
            Astro Cours — Sagesse Céleste
          </p>
        </footer>
