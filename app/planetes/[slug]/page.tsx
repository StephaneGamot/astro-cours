  ...
  const jsonLdGraph = {
    ...
    "@graph": [
      ...
      buildCourseNode({
        ...
        name: `${planet.name} en astrologie — Symbolisme et interprétation`,
        description: planet.identite?.symbolique || `Étude approfondie de ${planet.name} en astrologie.`,
        image: heroSrc,
        teaches: `Interpréter la position de ${planet.name} dans un thème natal`,
        topicName: `${planet.name} (planète astrologique)`,
      }),
      {
        "@type": "BreadcrumbList",
